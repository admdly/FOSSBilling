...
class AdminTest extends TestCase
{
    ...
    public function testGet(): void
    {
        ...
        $apiMock = $this->getMockBuilder(Admin::class)->onlyMethods(['_getOrder'])->disableOriginalConstructor()->getMock();
    ...
    public function testRenewPendingSetup(): void
    {
        ...
        $apiMock = $this->getMockBuilder(Admin::class)->onlyMethods(['_getOrder', 'activate'])->disableOriginalConstructor()->getMock();
        $apiMock->expects($this->atLeastOnce())
            ->method('_getOrder')
            ->willReturn($order);
        $apiMock->expects($this->atLeastOnce())
