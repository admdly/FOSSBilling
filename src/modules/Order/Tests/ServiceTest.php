...
class ServiceTest extends \BBTestCase
{
    ...
    public function testOnAfterAdminOrderActivate(): void
    {
        ...
        $serviceMock = $this->getMockBuilder('\\' . \Box\Mod\Order\Service::class)->onlyMethods(['getOrderServiceData', 'toApiArray'])->disableOriginalConstructor()->getMock();
    ...
    public function testOnAfterAdminOrderCancel(): void
    {
        ...
        $serviceMock = $this->getMockBuilder('\\' . \Box\Mod\Order\Service::class)->onlyMethods(['toApiArray'])->disableOriginalConstructor()->getMock();
        $serviceMock->expects($this->atLeastOnce())->method('toApiArray')
            ->willReturn($orderArr);
    ...
    public function testGetSoonExpiringActiveOrders(): void
    {
        ...
        $serviceMock = $this->getMockBuilder('\\' . \Box\Mod\Order\Service::class)->onlyMethods(['getSoonExpiringActiveOrdersQuery'])->disableOriginalConstructor()->getMock();
