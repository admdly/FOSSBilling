...
class AdminTest extends \BBTestCase
{
    public function testgetDi(): void
    {
        ...
        $admin_Client = new \Box\Mod\Client\Api();
    ...
    {
        $activityMock = $this->getMockBuilder('\\' . \Box\Mod\Client\Api::class)->onlyMethods(['delete'])->getMock();
    ...
    {
        $activityMock = $this->getMockBuilder('\\' . \Box\Mod\Client\Api::class)->onlyMethods(['login_history_delete'])->getMock();
